...
Учебный пет-проект системного аналитика: полный цикл документации от сбора требований
до проектирования REST API, событийной интеграции через Kafka и модели данных.

**Автор:** [Ваше имя] · **Цель:** портфолио для позиции Junior системного аналитика

---

## О проекте

Владелец сети футбольных комплексов принимает бронирования вручную (звонки, WhatsApp),
